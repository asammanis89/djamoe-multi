        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning btn-sm" onclick="editFlyer({{ $flyer->id }}, '{{ asset('storage/'.$flyer->image_url) }}')">
                            <i class="fas fa-edit"></i> Edit
                        </button>

                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $flyer->id }}, 'Flyer #{{ $loop->iteration }}')">
                            <i class="fas fa-trash"></i> Hapus
                        </button>
                        <form id="delete-form-{{ $flyer->id }}" action="{{ route('admin.flyers.destroy', $flyer) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                        </td>
...
{{-- 
    ==================================================
    PERUBAHAN DI SINI: Script & Style dipindah ke section 'js' 
    ==================================================
--}}
@section('js')
<script>
