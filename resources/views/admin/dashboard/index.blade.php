            ...
            <div class="col-lg-4 mb-4">
                <div class="welcome-card">
                    ...
                    <div class="d-flex flex-column">
                        {{-- ================================================== --}}
                        {{-- PERUBAHAN FUNGSI DI SINI: Link ke .index          --}}
                        {{-- ================================================== --}}
                        <a href="{{ route('admin.products.index') }}" class="btn btn-light quick-action-btn mb-3">
                            <i class="fas fa-plus-circle mr-2"></i>Tambah Produk
                        </a>
                        <a href="{{ route('admin.articles.index') }}" class="btn btn-outline-light quick-action-btn">
...
{{-- ================================================== --}}
{{-- PERUBAHAN STRUKTUR: Style & Script dipindah ke 'js' --}}
{{-- ================================================== --}}
@section('js')
<style>
    :root {
