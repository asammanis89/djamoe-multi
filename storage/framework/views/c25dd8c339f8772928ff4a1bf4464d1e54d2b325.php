...
<section class="relative h-[60vh] bg-cover bg-center flex items-center justify-center text-center text-white"
    ...
    <div class="reveal-animation">
        <h1 class="text-4xl md:text-7xl font-serif font-bold text-accent"><?php echo e(__('Kisah Kami')); ?></h1>
        
        <p class="mt-4 text-base md:text-xl max-w-3xl mx-auto text-white/90"><?php echo e(__('Dari Dapur Sederhana, Menjadi Warisan Kebaikan untuk Indonesia.')); ?></p>
    </div>
</section>
...
<section class="py-12 md:py-24">
    <div class="container mx-auto px-4 space-y-12 md:space-y-24">
        ...
        <div class="flex flex-col <?php echo e($loop->even ? 'md:flex-row-reverse' : 'md:flex-row'); ?> items-center gap-8 md:gap-16 reveal-animation">
            <div class="md:w-1/2">
                <img src="<?php echo e(asset('storage/' . $item->image)); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-auto object-cover aspect-video rounded-2xl" loading="lazy" decoding="async">
            </div>
            <div class="md:w-1/2 text-center <?php echo e($loop->even ? 'md:text-right' : 'md:text-left'); ?>">
                ...
                <h3 class="text-3xl md:text-5xl font-serif font-bold mt-2 text-accent"><?php echo e($item->title); ?></h3>
                <div class="w-24 h-px bg-accent/30 my-6 mx-auto <?php echo e($loop->even ? 'md:ml-auto md:mr-0' : 'md:mx-0'); ?>"></div>
                
                <p class="text-base md:text-lg text-light-text/80 leading-relaxed normal-case"><?php echo e($item->description); ?></p>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="text-center text-accent/70 py-12"><p><?php echo e(__('Belum ada cerita yang ditambahkan.')); ?></p></div>
        <?php endif; ?>
    </div>
</section>
...
<section class="py-12 md:py-20 bg-dark-card">
    <div class="container mx-auto px-4 text-center">
        ...
        <h2 class="text-3xl md:text-5xl font-serif font-bold text-accent reveal-animation"><?php echo e(__('Kekuatan dari Alam')); ?></h2>
        <p class="mt-2 mb-8 md:mb-12 text-base md:text-lg text-accent/70 max-w-2xl mx-auto reveal-animation" style="transition-delay: 100ms;"><?php echo e(__('Setiap tegukan D\'jamoe mengandung kebaikan dari rempah-rempah pilihan Indonesia.')); ?></p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div class="card-container reveal-animation" style="transition-delay: 200ms;">
                ...
                <div class="spice-card bg-dark-bg p-4 md:p-8 rounded-2xl shadow-lg h-full">
                    ...
                    <h3 class="mt-4 text-lg md:text-2xl font-serif font-bold"><?php echo e(__('Kunyit')); ?></h3>
                    <p class="mt-2 text-sm md:text-base text-light-text/70"><?php echo e(__('Anti-inflamasi alami yang kuat...')); ?></p>
                </div>
            </div>
            <div class="card-container reveal-animation" style="transition-delay: 300ms;">
                <div class="spice-card bg-dark-bg p-4 md:p-8 rounded-2xl shadow-lg h-full">
                    ...
                    <h3 class="mt-4 text-lg md:text-2xl font-serif font-bold"><?php echo e(__('Jahe')); ?></h3>
                    <p class="mt-2 text-sm md:text-base text-light-text/70"><?php echo e(__('Menghangatkan tubuh, meningkatkan imunitas...')); ?></p>
                </div>
            </div>
            <div class="card-container reveal-animation" style="transition-delay: 400ms;">
                <div class="spice-card bg-dark-bg p-4 md:p-8 rounded-2xl shadow-lg h-full">
                    ...
                    <h3 class="mt-4 text-lg md:text-2xl font-serif font-bold"><?php echo e(__('Kencur')); ?></h3>
                    <p class="mt-2 text-sm md:text-base text-light-text/70"><?php echo e(__('Membantu meredakan batuk dan pegal linu...')); ?></p>
                </div>
            </div>
            <div class="card-container reveal-animation" style="transition-delay: 500ms;">
                <div class="spice-card bg-dark-bg p-4 md:p-8 rounded-2xl shadow-lg h-full">
                    ...
                    <h3 class="mt-4 text-lg md:text-2xl font-serif font-bold"><?php echo e(__('Temulawak')); ?></h3>
                    <p class="mt-2 text-sm md:text-base text-light-text/70"><?php echo e(__('Menjaga kesehatan hati, bertindak sebagai antioksidan...')); ?></p>
                </div>
            </div>
        </div>
...
<section class="py-12 md:py-20 text-center">
    <div class="container mx-auto px-4">
        <div class="reveal-animation">
            <h2 class="text-2xl md:text-4xl font-serif font-bold text-accent"><?php echo e(__('Jelajahi Kebaikan di Setiap Botolnya')); ?></h2>
            <p class="mt-4 text-base md:text-lg text-light-text/70 max-w-2xl mx-auto"><?php echo e(__('Temukan varian jamu yang diciptakan khusus untuk menemani hari...')); ?></p>
